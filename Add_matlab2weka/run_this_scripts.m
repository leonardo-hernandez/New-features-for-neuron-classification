...
disp(' Some part of process need to do manually, this  will be clarified')
disp(' previously.')
disp('                                                                    ')
...
disp(' You can type "gtrees = cellcelloftree" to ruun this step')
disp(' We use “AlzheimerLocal.mtr" file created previously')
disp('                                                                    ')
disp('                  PRESS RETURN TO CONTINUE.                         ')
pause
clc
...
disp(' In this example we only calculate the time series for SS-WOJ dataset')
disp('                                                                    ')
disp('                  PRESS RETURN TO CONTINUE.                         ')
disp('                                                                    ')
pause
...
trees_path = 'D:\NeuronTracing\!!Entregar_JVLG\Versión_nueva\Scripts\TREES1.15';
addpath(trees_path);
disp('                                                                    ')
start_trees
...
disp(' Series toolkit (MATS). In MATS all operations should be running')
...
disp(' {''functions''}, [128 64 32 16 8 4 3 2 1]);')
...
disp(' groups = eval_classif({''ChiSquaredAttributeEval''},...')
disp(' {''functions''}, [64 32 16 8 4 3 2 1]);')
disp(' select_class_experimenter(ft_train_weka,groups,...')
...
disp('                                                                    ')
disp('           THE GRAPHIC RESULT WILL SHOW IN TWO FIGURES              ')
disp('                                                                    ')
disp('                   PRESS RETURN TO CONTINUE.                        ')
pause
clc
